...
const OtpResetPasswordEmail: React.FC<Props> = ({
  otp,
  expiredIn = "5 menit",
}) => {
  return (
          ...
          <div className="space-y-8 text-center">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 text-base leading-relaxed max-w-md mx-auto">
                Gunakan kode di bawah ini untuk memverifikasi permintaan reset
                kata sandi akun SAKU Anda.
              </p>
            </div>
            ...
            <div className="bg-red-100 rounded-xl p-4 flex items-start gap-4 text-left border-l-4 border-red-500">
              ...
              <div>
                ...
                <p className="text-xs text-red-600">
                  Jangan berikan kode ini kepada siapapun, termasuk pihak yang
                  mengaku dari SAKU. Tim kami tidak akan pernah meminta kode ini.
                </p>
              </div>
            </div>
            ...
            <p className="text-gray-500 text-xs italic">
              Jika Anda tidak meminta reset password, abaikan email ini atau
